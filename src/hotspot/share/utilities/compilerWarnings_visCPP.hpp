...
// /MD defines _DLL and declares the Universal CRT entry points as dllimport.
// The XP-compatible Windows build uses /MT so those same declarations have
// ordinary external linkage.  Keep the HotSpot redeclarations consistent
// with the CRT mode selected by the compiler.
#ifdef _DLL
